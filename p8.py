##for loop,list, and dictionaries
...
#menentukan operasi logika
	if (pilihan == 'add' or pilihan=='+'):							#proses boolean ==, atau percabangan
		print ("Hasil",add(no1,no2))
	elif (pilihan == 'sub' or pilihan=='-'):
		print ("Hasil",sub(no1,no2))
	elif (pilihan == 'mul' or pilihan=='*'):
		print ("Hasil",mul(no1,no2))
	elif (pilihan == 'div' or pilihan=='/'):
...
if __name__ == "__main__":					#untuk mengecek apakah ini filnya yang akan berjalan?
